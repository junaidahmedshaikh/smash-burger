      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
          <div className="space-y-6">
            <h2 className="font-display font-black text-3xl sm:text-4xl text-brand-cream uppercase tracking-tight">
              WHY WE SMASH
            </h2>
        ...
        {/* CTA Banner */}
        <div className="p-12 rounded-3xl bg-gradient-to-r from-brand-red to-brand-red-dark text-center text-brand-cream shadow-brand-glow">
          <h2 className="font-display font-black text-3xl sm:text-5xl uppercase tracking-tight mb-4">
